...
import { BalancerVault } from "../../generated/ExodiaERC20Token/BalancerVault"
...
import { WeightedPool } from "../../generated/ExodiaERC20Token/WeightedPool"
...
function updateBptLiquidity(address: Address, dayTimestamp: string, balance: BigDecimal = BigDecimal.zero(), fetchBalance: boolean = true): TokenValue {
  ...
  if (poolId.reverted) {
    ...
    if (vestingToken.reverted) {
      return updateTokenBalance(address, dayTimestamp, false, liquidity.balance, "", fetchBalance)
    } else {
      ...
      return updateTokenBalance(address, dayTimestamp, false, liquidity.balance, "", false)
    }
  }
